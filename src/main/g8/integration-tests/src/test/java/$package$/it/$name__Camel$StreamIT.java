...
import $package$.$name;format="norm"$-stream.api.$name;format="Camel"$StreamService;
...
// interface $name;format="Camel"$StreamService extends Service {
public class $name;format="Camel"$StreamIT {
    ...
    private static $name;format="Camel"$StreamService $name;format="norm"$-streamService;
    ...
    public static void setup() {
        ...
        $name;format="norm"$-streamService = clientFactory.createDevClient($name;format="Camel"$StreamService.class, URI.create(SERVICE_LOCATOR_URI));
    ...
    public void helloStream() throws Exception {
        ...
        Source<String, ?> response = await($name;format="norm"$-streamService.directStream().invoke(
